...
public class ShapeChanger : MonoBehaviour
{
    ...
    public PhysicalObject activeObject = PhysicalObject.Small;
    private PhysicalObject previousObject = PhysicalObject.Small;
    ...
    void Update()
    {
        if (previousObject != activeObject) {
            ...
            switch (activeObject) {
                case PhysicalObject.Small:
                    small.SetActive(true);
                    break;
                case PhysicalObject.Medium:
                    medium.SetActive(true);
                    break;
                case PhysicalObject.Large:
                    large.SetActive(true);
                    break;
                case PhysicalObject.Convex:
                    convex.SetActive(true);
                    break;
                case PhysicalObject.Concave:
                    concave.SetActive(true);
                    break;
                case PhysicalObject.Slope:
        ...
        if (changeOffset) {
            medium.transform.position = small.transform.position + mediumOffset;
            large.transform.position = small.transform.position + largeOffset;
            convex.transform.position = small.transform.position + footballOffset;
            concave.transform.position = small.transform.position + piggyBankOffset;
            slope.transform.position = small.transform.position + shellOffset;
        }
        ...
        if (Input.GetKeyDown(KeyCode.Alpha1)) {
            ...
            small.transform.position = homePos;
            medium.transform.position = small.transform.position + mediumOffset;
            large.transform.position = small.transform.position + largeOffset;
            convex.transform.position = small.transform.position + footballOffset;
            concave.transform.position = small.transform.position + piggyBankOffset;
            ...
            if (activeObject == PhysicalObject.Medium) {
                visualOffset = 0.0f;
                medium.transform.position = new Vector3(medium.transform.position.x, medium.transform.position.y + visualOffset, medium.transform.position.z);
            } else if (activeObject == PhysicalObject.Small) {
                visualOffset = -0.01f;
                small.transform.position = new Vector3(small.transform.position.x, small.transform.position.y + visualOffset, small.transform.position.z);
            } else if (activeObject == PhysicalObject.Large) {
                visualOffset = -0.02f;
                large.transform.position = new Vector3(large.transform.position.x, large.transform.position.y + visualOffset, large.transform.position.z);
            } else if (activeObject == PhysicalObject.Convex) {
                visualOffset = -0.02f;
                convex.transform.position = new Vector3(convex.transform.position.x, convex.transform.position.y + visualOffset, convex.transform.position.z);
            } else if (activeObject == PhysicalObject.Concave) {
                visualOffset = 0.0f;
                concave.transform.position = new Vector3(concave.transform.position.x, concave.transform.position.y + visualOffset, concave.transform.position.z);
            } else if (activeObject == PhysicalObject.Slope) {
                visualOffset = -0.01f;
                slope.transform.position = new Vector3(slope.transform.position.x, slope.transform.position.y + visualOffset, slope.transform.position.z);
            }
        }
        ...
        if (tracking) {
            small.transform.position = new Vector3(hand.position.x + calibOffsetOneHand.x, hand.position.y + calibOffsetOneHand.y, hand.position.z + calibOffsetOneHand.z);
            medium.transform.position = small.transform.position + mediumOffset;
            large.transform.position = small.transform.position + largeOffset;
            convex.transform.position = small.transform.position + footballOffset;
            concave.transform.position = small.transform.position + piggyBankOffset;
    ...
    public void ScaleVisual()
    {
        ...
        small.transform.localScale = new Vector3(scaleVal, scaleVal, scaleVal);
    ...
    public void CalibrateVisual()
    {
        ...
        //}
        homePos = small.transform.position;
    }
    ...
    public IEnumerator DynamicVisual(int direction)
    {
        ...
        float startScale = small.transform.localScale.x;
        ...
        small.transform.localScale = new Vector3(startScale, startScale, startScale);
        ...
        while (elapsed <= duration)
        {
            ...
            small.transform.localScale = Vector3.Lerp(new Vector3(startScale, startScale, startScale), new Vector3(endScale, endScale, endScale), t);
            ...
            float visualOffset = (physicalRadiusChange * 0.02f + 0.1258f) - small.transform.localScale.y;
    ...
    {
        Color originalColor = small.GetComponent<Renderer>().material.color;
        for (int i = 0; i < 3; i++)
        {
            small.GetComponent<Renderer>().material.color = Color.red;
            yield return new WaitForSeconds(0.3f);
            small.GetComponent<Renderer>().material.color = originalColor;
            yield return new WaitForSeconds(0.3f);
        }
    }
